...
!>@brief The module 'nh_core' peforms non-hydrostatic computations include moisture effect in pt.
...
#ifdef MULTI_GASES
!$OMP                                  peln,pk,fp_out,ppe,use_logp,zs,pe,cappa,q_con,kapad,d2bg_zq,debug,fast_tau_w_sec )          &
